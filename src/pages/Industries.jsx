...
const Industries = () => {
  ...
  const industries = [
    ...
    },
    {
      ...
      img: 'images/kraft_paper_reel.jpg',
    ...
    },
    {
      ...
      icon: <Zap size={32}/>,
      name: 'Electronics',
      img: 'images/corrugated_roll.jpg',
    ...
    <div className="industries-page">
        ...
        <div className="container hero-container" style={{ position: 'relative', zIndex: 10, paddingBottom: '3rem' }}>
          ...
          <div style={{ flex: '1 1 300px', display: 'flex', justifyContent: 'center' }}>
            <div className="conic-container" style={{ borderRadius: '24px', padding: '6px', boxShadow: '0 20px 40px rgba(0,0,0,0.3)', width: '100%', maxWidth: '500px', background: 'var(--bg-color)' }}>
              <img 
                src="images/standard_corrugated.jpg" 
          ...
          <div className="products-grid">
            <div className="conic-container conic-card" style={{ padding: '4px', height: '100%' }}>
              <div style={{ position: 'relative', zIndex: 2, background: 'var(--bg-color)', borderRadius: '16px', height: '100%', overflow: 'hidden' }}>
                <img src="images/corrugated_roll.jpg" alt="Electronics Materials" style={{ width: '100%', height: '200px', objectFit: 'cover' }} />
            ...
            <div className="conic-container conic-card" style={{ padding: '4px', height: '100%' }}>
              <div style={{ position: 'relative', zIndex: 2, background: 'var(--bg-color)', borderRadius: '16px', height: '100%', overflow: 'hidden' }}>
                <img src="images/premium_box.jpg" alt="Food Barrier Films" style={{ width: '100%', height: '200px', objectFit: 'cover' }} />
                <div style={{ padding: '1.5rem' }}>
            ...
            <div className="conic-container conic-card" style={{ padding: '4px', height: '100%' }}>
              <div style={{ position: 'relative', zIndex: 2, background: 'var(--bg-color)', borderRadius: '16px', height: '100%', overflow: 'hidden' }}>
                <img src="images/standard_corrugated.jpg" alt="Heavy Duty Corrugated" style={{ width: '100%', height: '200px', objectFit: 'cover' }} />
                <div style={{ padding: '1.5rem' }}>
        ...
        <div className="container">
          <div className="about-grid">
            ...
            <div className="case-study-image conic-container conic-card" style={{ padding: '4px' }}>
              <img src="images/corrugated_roll.jpg" alt="Electronics Case Study" style={{ width: '100%', height: 'auto', borderRadius: '14px', position: 'relative', zIndex: 2 }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="about-grid" style={{ direction: 'rtl' }}>
            <div className="conic-container conic-card" style={{ padding: '4px', height: '100%', direction: 'ltr' }}>
              <img src="images/kraft_paper_reel.jpg" alt="CAD Packaging Design" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px', position: 'relative', zIndex: 2 }} />
            </div>
      ...
      <section className="vmi-section section-padding">
        <div className="container">
          <div className="about-grid">
            <div className="conic-container conic-card" style={{ padding: '4px', height: '100%' }}>
              <img src="images/die_cut_mailer.jpg" alt="Vendor Managed Inventory" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px', position: 'relative', zIndex: 2 }} />
            </div>
      ...
      <section className="logistics-section section-padding">
        <div className="container">
          <div className="about-grid">
            <div className="conic-container conic-card" style={{ padding: '4px', height: '100%' }}>
              <img src="images/standard_corrugated.jpg" alt="Global Supply Chain" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px', position: 'relative', zIndex: 2 }} />
            </div>
      ...
      <section className="sample-cta-section section-padding" style={{ position: 'relative', overflow: 'hidden' }}>
        <div className="hero-bg" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0, opacity: 0.15 }}>
          <img src="images/premium_box.jpg" alt="Premium Packaging CTA" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
