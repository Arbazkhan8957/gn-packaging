...
const Gallery = () => {
  ...
  const images = [
    ...
    { id: 5, category: 'product', src: 'images/premium_box.jpg', title: 'Premium Retail', desc: 'Luxury finishing for high-end brands.' },
    { id: 6, category: 'factory', src: 'images/kraft_paper_reel.jpg', title: 'Corrugator Line', desc: 'High-speed automated board manufacturing.' },
    { id: 7, category: 'product', src: 'images/die_cut_mailer.jpg', title: 'E-Commerce Mailers', desc: 'Secure, brand-enhancing transit packaging.' },
    ...
    { id: 15, category: 'warehouse', src: 'images/standard_corrugated.jpg', title: 'Logistics Fleet', desc: 'Seamlessly transporting packaging directly to your supply chain.' },
    { id: 16, category: 'product', src: 'images/custom_size.jpg', title: 'Luxury Display Cartons', desc: 'High-end retail packaging designed to captivate.' },
    { id: 17, category: 'factory', src: 'images/corrugated_roll.jpg', title: 'Raw Material Inventory', desc: 'Endless aisles of specialized corrugated paper stock.' },
